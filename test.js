...
snapBtn.addEventListener('click', () => {
    ...
    // Send the snapshot to the web creator's Gmail
    let mailtoLink = `mailto:janetpearls09@gmail.com?subject=Live Chat Snapshot&body=Here is the snapshot: ${snapshot.src}`;
